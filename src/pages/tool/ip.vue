<template>
    <el-card style="margin:30px">
      ...
      <h3 class="search">公网 IP 地址: <el-input v-model="ips" style="width: 150px  " size="large"/></h3>
      <h3 class="search">IP 协议: <el-input v-model="ipx" style="width: 150px " size="large"/></h3>
      <br>
      <h3 class="search">所在位置: <el-input v-model="ipp" style="width: 150px " size="large"/></h3>
      <h3 class="search">邮政编码: <el-input v-model="ipy" style="width: 150px " size="large"/></h3>
      <h3 class="search">服务商: <el-input v-model="ipf" style="width: 150px " size="large"/></h3><br><br>
