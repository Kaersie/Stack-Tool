    <template>
		<div class="layout">
			<keep-alive>
				<VueDragSplit :generateWindowConfig="generateWindowConfig" v-model:windowListSync="windowList"
					v-model:activeTabKeySync="activeTabKey" @closeWindow="onCloseWindow" @resize="onResize"
					@dragEnd="onDragend">
					<template #Tab="win">
					...
					<template #TabView="win">
						<div style="height:100%">
							<iframe src="#/index2" scrolling="yes" frameborder="0"
